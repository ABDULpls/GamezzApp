<template>
    <div class="checkmail">
        ...
        <p class="text-gradient checkmail__nomail" @click="toForgotPasswordPage">Письмо не пришло?</p>
        <button class="btn checkmail__btn btn-border" @click="toLoginPage">Войти</button>
    </div>
</template>
