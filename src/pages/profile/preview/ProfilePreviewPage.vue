	...
	<div class="more">
		...
		<div class="more__items">
			<router-link class="more__item" tag="div" :to="{name: profileMenu.dialogs.routeName}">
				<img :src="'/src/assets/images/sprite.svg#' + profileMenu.dialogs.className" width="33" height="45" alt="pic">
			...
			<router-link class="more__item" tag="div" :to="{name: profileMenu.wallet.routeName}">
